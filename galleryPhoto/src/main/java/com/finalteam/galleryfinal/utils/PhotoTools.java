...
package com.finalteam.galleryfinal.utils;
...
import com.finalteam.galleryfinal.model.PhotoFolderInfo;
...
public class PhotoTools {
     ...
     * @return
     */
    public static List<PhotoFolderInfo> getAllPhotoFolder(Context context, ArrayList<PhotoInfo> selectPhotoList) {
        ...
        allPhotoFolderInfo.setFolderName(context.getResources().getString(cn.finalteam.galleryfinal.R.string.all_photo));
        ...
        try {
            ...
            if (cursor != null) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    final int sizeIdColumn = cursor.getColumnIndex(MediaStore.Images.Media.SIZE);
                    ...
                    final String size = cursor.getString(sizeIdColumn);
                    if(TextUtils.isEmpty(size) || Long.parseLong(size) <= 1024* 5 ){
                        continue;
                    }
