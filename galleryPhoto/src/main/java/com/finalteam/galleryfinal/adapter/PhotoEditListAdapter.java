...
public class PhotoEditListAdapter extends ViewHolderAdapter<PhotoEditListAdapter.ViewHolder, PhotoInfo> {
    ...
    public class ViewHolder extends ViewHolderAdapter.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mIvPhoto = (GFImageView) view.findViewById(cn.finalteam.galleryfinal.R.id.iv_photo);
            mIvDelete = (ImageView) view.findViewById(cn.finalteam.galleryfinal.R.id.iv_delete);
        }
    }
