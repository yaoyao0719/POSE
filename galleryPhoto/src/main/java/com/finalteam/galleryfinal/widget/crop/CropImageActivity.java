...
//                setCropSaveException(e);
    ...
    private void startCrop() {
        ...
        CropUtil.startBackgroundJob(this, null, getResources().getString(cn.finalteam.galleryfinal.R.string.waiting),
                new Runnable() {
                    public void run() {
    ...
    private void saveImage(Bitmap croppedImage, final File saveFile) {
        if (croppedImage != null) {
            ...
            CropUtil.startBackgroundJob(this, null, getResources().getString(cn.finalteam.galleryfinal.R.string.saving),
                    new Runnable() {
                        public void run() {
