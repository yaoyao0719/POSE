...
public class FunctionConfig implements Cloneable{
    ...
    public static class Builder {
        ...
        private int maxSize;
        private boolean editPhoto = false;//编辑
        private boolean crop = false;//裁剪
        private boolean rotate = false;//旋转
        private boolean camera= true;
        private int cropWidth;
        private int cropHeight;
        private boolean cropSquare = true;
        private boolean rotateReplaceSource = false;//旋转是否覆盖源文件
        private boolean cropReplaceSource = false;//裁剪是否覆盖源文件
        private ArrayList<String> selectedList;
        ...
        public Builder setShowFull(boolean showFull) {
