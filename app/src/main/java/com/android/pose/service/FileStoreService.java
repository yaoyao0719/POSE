package com.android.pose.service;
...
import com.android.pose.PoseApplication;
import com.android.pose.utils.FileUtils;
...
public class FileStoreService {
    ...
    public static String getCacheDir(){
        if ( Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())){
            ...
            return PoseApplication.getInstance().getCacheDir()+"/cache";
        }
    }
    ...
    public static String getCacheDirExternal(){
        File externalCacheDir = PoseApplication.getInstance().getExternalCacheDir();
    ...
    public static String getIMDir(String childDir){
        ...
        if ( Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())){
            ...
            path = PoseApplication.getInstance().getCacheDir().getAbsolutePath()+"/im/"+childDir;
        }
    ...
    public static boolean saveImage(File from){
       String rootDir = getSDRootDir();
        ...
        try {
            ...
            PoseApplication.getInstance().sendBroadcast(new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(new File(targetImgPath))));
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
