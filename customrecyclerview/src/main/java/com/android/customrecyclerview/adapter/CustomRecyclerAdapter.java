...
import com.android.customrecyclerview.listener.ItemTouchAdapter;
 ...
 */
public class CustomRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTouchAdapter {
    ...
    public CustomRecyclerAdapter(final RecyclerView.Adapter mPlugAdapter){
        ...
        mPlugAdapter.registerAdapterDataObserver(new RecyclerView.AdapterDataObserver() {
            ...
            public void onItemRangeChanged(int positionStart, int itemCount) {
                CustomRecyclerAdapter.this.notifyItemRangeChanged(positionStart + getHeaderViewCount(), itemCount);
            }
            ...
            public void onItemRangeInserted(int positionStart, int itemCount) {
                ...
                CustomRecyclerAdapter.this.notifyItemRangeInserted(truePositionStart, itemCount);
            }
            ...
            public void onItemRangeRemoved(int positionStart, int itemCount) {
                ...
                CustomRecyclerAdapter.this.notifyItemRangeRemoved(truePositionStart, itemCount);
            }
            ...
            public void onItemRangeMoved(int fromPosition, int toPosition, int itemCount) {
                ...
                CustomRecyclerAdapter.this.notifyItemMoved(truePositionStart, truePositionEnd);
            }
        });
    }
